...
public class AsymmetricEncryptor
{
    ...
    public string Encrypt(string plaintext)
    {
        ...
        // 3. convert byte array to hex string and return.
        return ByteArrayFunctions.ByteArrayToString(encrypted);
    }

    public string Decrypt(string encryptedBase64)
    {
        // 1. convert the encrypted hex string to a byte array.
        var encrypted = ByteArrayFunctions.StringToByteArray(encryptedBase64);
